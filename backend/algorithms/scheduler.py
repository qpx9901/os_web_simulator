...
@scheduler_bp.route('/scheduler/fcfs', methods=['POST'])
def fcfs():
    data = request.json
...
@scheduler_bp.route('/scheduler/rr', methods=['POST'])
def rr():
...
#3.抢占式
# =========================
@scheduler_bp.route('/scheduler/sjf', methods=['POST'])
def sjf():
...
#4.HRN
# =========================
@scheduler_bp.route('/scheduler/hrn', methods=['POST'])
def hrn():
